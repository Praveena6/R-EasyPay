...
<div style="position: relative;min-height:50vh; background-image:  linear-gradient(
    ...
    <h1 class="text-center" id="title">View Your Account Details</h1>
  ...
  <div class="center" >
    <center>
      <table class="text-center responsive-table">
      <tr> 
      <th class="col col-1">Name</th>
      <th class="col col-2">Account Number</th>
      <th class="col col-3">IFSC Number</th>
      ...
      <td class="col col-1"><?php echo $row["name"]; ?></td>
      <td class="col col-2"><?php echo $row["accno"]; ?></td>
      <td class="col col-3"><?php echo $row["ifsc"]; ?></td>
      <td class="col col-4"><?php echo $row["balance"]; ?></td>
      </tr>
      <?php
      $i++;
      }
