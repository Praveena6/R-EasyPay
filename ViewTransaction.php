...
.custom-shape-divider-bottom-1637758452 .shape-fill {
  ...
  <body>
    ...
    <form class="text-center">
      ...
      <input type="text" name="accno" id="accno" value="<?php if (isset($_GET["accno"])) echo $_GET["accno"]; ?>"/> 
...
<div class="row">
    <div class="col col-md-2">
      <a href="transfermoney.php"> <button type="button" class="btn btn-login" >Transaction</button>
    </div>
    <div class="col col-md-2">
